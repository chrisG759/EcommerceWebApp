...
class Account(db.Model):
    ...
    first_name = db.Column(db.String(255), nullable=False)  # Adjust column name
    type = db.Column(db.String(45), nullable=False)
    last_name = db.Column(db.String(255), nullable=False)  # Adjust column name

    carts = relationship('Cart', backref='account')
